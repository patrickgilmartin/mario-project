...
function preload() {
    this.load.image('background', 'wp7619435.png'); // Make sure to use the correct path to your image
    this.load.spritesheet('mario', 'Mario.2.png', { frameWidth: 30, frameHeight: 60 }); // Adjust frame size as necessary
}
